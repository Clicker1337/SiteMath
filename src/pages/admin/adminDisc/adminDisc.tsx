...
import AdminDisc from '../../../components/ui/admin/adminDisc/AdminDisc';
            ...
            <div className="container">
                <div className={clsx(s.container)}>
                    <section className={s.container__header}>
                        <p className={s.container__header__title}>Дисциплины</p>
                        <DropDown
                            callback={option}
                            items={items}
